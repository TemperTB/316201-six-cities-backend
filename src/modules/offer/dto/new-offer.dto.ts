...
import {IsArray, IsBoolean, IsDateString, IsEnum, IsInt, IsLatitude, IsLongitude, IsMongoId, IsString, Max, MaxLength, Min, MinLength} from 'class-validator';


export default class NewOfferDto {
